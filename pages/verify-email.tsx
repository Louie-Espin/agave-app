...
const VerifyEmail: NextPage<VerifyEmailProps> = () => {
    ...
    const sendEmail: any = async () => {
        ...
        try {
            ...
            return console.error((e instanceof Error) ? e.message : "Unknown Error occurred!");
        }
                ...
                <Container sx={{ mt: "3rem" }}>
                    ...
                    <Container>
                        <Box mb={4}>
                            ...
                            <Button disabled={buttonDisabled} fullWidth onClick={sendEmail} color="primary" variant="contained" sx={{ mb: "1.65rem", height: 44 }}>
